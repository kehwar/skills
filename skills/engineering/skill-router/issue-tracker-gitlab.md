...
**MRs as a request surface: no.** _(Set to `yes` if this repo treats external merge requests as feature requests; skill_view('triage') reads this flag.)_
...
Used by skill_view('wayfinder'). The **map** is a single issue with **child** issues as tickets.
