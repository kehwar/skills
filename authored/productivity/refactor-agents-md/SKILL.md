...
description: Refactor and consolidate AGENTS.md files using progressive disclosure principles. Extract essentials, group related instructions into separate files, and resolve contradictions.
---

Refactor AGENTS.md file to follow progressive disclosure principles.
